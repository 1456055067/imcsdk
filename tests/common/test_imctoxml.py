...
def test_001_mo_heirarchy_to_xml():
    ...
    response_str = r"""
        <configResolveClass
            cookie="1441601790/263349a7-1897-4df0-aff3-bc27c7316862"
            response="yes"
            classId="memoryUnit">
        ...
        <memoryUnit
            ...
            clock="1333"
            dn="sys/chassis-1/blade-2/board/memarray-1/mem-9"
            formFactor="DIMM"
            id="9"
            latency="0.800000"
            location="DIMM_E1"
            locationDn=""
            model="M393B5170FH0-YH9"
            operQualifier=""
        ...
        <memoryUnitEnvStats
            ...
            temperatureAvg="20.000000"
            temperatureMax="20.000000"
            temperatureMin="20.000000"
            thresholded=""
            timeCollected="2015-09-07T10:31:06.608"
            update="262146">
        ...
        <memoryUnitEnvStatsHist1
            ...
            temperatureAvg="25.599997"
            temperatureMax="28.000000"
            temperatureMin="24.000000"
            thresholded=""
            timeCollected="2015-09-07T09:43:53.262">

        <memoryUnitEnvStatsHist2
            childAction="deleteNonPresent"
            id="1" mostRecent="no" rn="1" suspect="no"
            temperature="28.000000"
            temperatureAvg="25.599997"
            temperatureMax="28.000000"
            temperatureMin="24.000000"
    ...
    assert xc.to_xml_str(obj.to_xml()) == expected
...
def test_mo_to_xml():
    ...
    assert len(mo.__dict__) == len(new_mo.__dict__)
    for prop in mo.__dict__:
        if prop == "_dirty_mask":
            continue
        assert getattr(mo, prop) == getattr(new_mo, prop)
